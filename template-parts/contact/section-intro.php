<section class="section section-contact__intro">
    <div class="container-fluid p-0">
        <div class="row g-0 section-contact__row justify-content-center" style="background:url('<?php echo wp_upload_dir()['url'] . '/bg_project.jpg' ?>') no-repeat;">
